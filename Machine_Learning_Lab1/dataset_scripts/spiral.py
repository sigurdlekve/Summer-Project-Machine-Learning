...
def spiral(N, s=1, wrappings = 4,  m=0.5):
    #Sample a dataset from a dataset separated by a sinusoidal line
    #   X, Y = spiral(N, s, wrappings, m)
    #    INPUT 
    #    N         1x2 vector that fix the numberof samples from each class
    #    s         standard deviation of the gaussian noise. Default is 1.0.
    #    wrappings number of wrappings of each spiral. Default is 4.
    #    m       multiplier m of x * sin(m * x) for the second spiral. Default is 0.5.
    #    OUTPUT
