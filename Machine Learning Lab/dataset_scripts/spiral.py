...
def spiral(N, s=0.35, wrappings = 2.5,  m=0.7):
    ...
    #    s         standard deviation of the gaussian noise. Default is 0.35.
    #    wrappings number of wrappings of each spiral. Default is 2.5.
    #    m       multiplier m of x * sin(m * x) for the second spiral. Default is 0.7.
    #    OUTPUT
